...
const HomePage = () => {
  return (
    <div id='acasa' className="relative w-full h-screen bg-cover bg-center bg-no-repeat bg-[url('/images/home_image_mobile.webp')] lg:bg-[url('/images/home_image_desktop.webp')]">
