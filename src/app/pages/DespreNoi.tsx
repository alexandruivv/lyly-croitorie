...
const servicii: ReactNode[] = [
  <p>Echipa noastra este localizata in <span className='font-semibold text-brownHover'>Piatra-Neamt</span> si beneficiaza
    de o <span className='font-semibold text-brownHover'>experienta</span> in croitorie de peste <span
      className='font-semibold text-brownHover'>10 ani</span>
  </p>
  ,
  <p>Măiestrim tehnici de cusut, folosind diverse tipuri de mașini, pentru a realiza <span
    className='font-semibold text-brownHover'>modele unice</span>, inclusiv din
    <span className='font-semibold text-brownHover'> materiale dificile și pretențioase</span>.</p>
  ,
  <p>Experiența acumulată de-a lungul anilor include <span className='font-semibold text-brownHover'>interacțiunea cu clienții</span>,
    <span className='font-semibold text-brownHover'> înțelegerea nevoilor</span> acestora și
    furnizarea de <span className='font-semibold text-brownHover'>soluții personalizate</span>.</p>
,
  <p>Înțelegem că fiecare proiect are provocările sale unice, motiv pentru care <span className='font-semibold text-brownHover'>ne adaptăm</span> cu ușurință cerințelor în
    schimbare.</p>,
];
      ...
      <div
        ...
        <div className='md:hidden'>
          <Carousel responsive={responsive} >
            <Image src={despreNoiImg} alt='despre-noi-image' className='rounded-xl lg:w-4/12'/>
            <Image src={despreNoiImg2} alt='despre-noi-image2' className='rounded-xl  lg:w-4/12'/>
          </Carousel>
        </div>
